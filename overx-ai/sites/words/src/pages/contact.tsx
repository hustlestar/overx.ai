...
export default function ContactPage() {
  ...
  const categories = [
    ...
    { value: 'subscription', label: t('contact.categories.subscription', 'Subscription / Billing') },
    { value: 'language', label: t('contact.categories.language', 'New Language Request') },
  ]

  return (
    <>
      <EnhancedSEO
        title={t('contact.pageTitle', 'Contact Us - World Word War Bot Support')}
        description={t('contact.pageDescription', 'Get help with World Word War language learning bot. Contact our support team for questions about learning, subscriptions, or feature requests.')}
        canonical="https://words.overx.ai/contact"
      />
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-400 light:text-gray-600 text-center mb-12 max-w-2xl mx-auto">
              {t('contact.subtitle', 'Have questions about World Word War? We\'re here to help you on your language learning journey.')}
            </p>
              ...
              <div className="glass-effect light:bg-white light:shadow-lg rounded-2xl p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    disabled={isSubmitting}
                    className="w-full py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                  >
                    {isSubmitting ? (
                      <>
              ...
              <div className="space-y-8">
                <div className="glass-effect light:bg-white light:shadow-lg rounded-2xl p-8">
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      <span>{t('contact.quickLinks.features', 'Bot Features')}</span>
                    ...
                    <Link
                      ...
                      className="flex items-center gap-2 text-blue-400 hover:text-blue-300 light:text-blue-600 light:hover:text-blue-700 transition-colors"
                    >
                      <span>{t('contact.quickLinks.pricing', 'Pricing Plans')}</span>
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                      </svg>
                    </Link>
                    <a
                      ...
                      className="flex items-center gap-2 text-blue-400 hover:text-blue-300 light:text-blue-600 light:hover:text-blue-700 transition-colors"
                    >
                      <span>{t('contact.quickLinks.bot', 'Try the Bot')}</span>
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="glass-effect light:bg-white light:shadow-lg rounded-2xl p-8">
                  <h3 className="text-xl font-bold text-white light:text-gray-900 mb-4">
                    {t('contact.languages.title', 'Supported Languages')}
                  </h3>
                  <p className="text-gray-400 light:text-gray-600 mb-4">
                    {t('contact.languages.description', 'We currently support 13 languages with more coming soon!')}
                  </p>
                  <div className="flex flex-wrap gap-2">
                    {['English', 'Spanish', 'French', 'German', 'Italian', 'Portuguese', 'Russian', 'Japanese', 'Chinese', 'Korean', 'Arabic', 'Hindi', 'Dutch'].map((lang) => (
                      <span key={lang} className="px-2 py-1 bg-blue-500/20 light:bg-blue-100 text-blue-300 light:text-blue-700 rounded text-sm">
                        {lang}
                      </span>
                    ))}
                  </div>
                  ...
                  <div className="space-y-4 text-sm">
                    <div>
                      <p className="text-gray-300 light:text-gray-700 font-medium mb-1">
                        {t('contact.faq.q1', 'Is the bot free to use?')}
                      </p>
                      <p className="text-gray-500 light:text-gray-500">
                        {t('contact.faq.a1', 'Yes! The basic version is free. Premium plans offer additional features.')}
                      </p>
                    </div>
                    <div>
                      <p className="text-gray-300 light:text-gray-700 font-medium mb-1">
                        {t('contact.faq.q2', 'How do I get started?')}
                      </p>
                      <p className="text-gray-500 light:text-gray-500">
                        {t('contact.faq.a2', 'Just message @world_word_war_bot on Telegram to begin!')}
                      </p>
                    </div>
                  </div>
                </div>
