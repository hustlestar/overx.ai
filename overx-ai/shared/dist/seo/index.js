...
var BaseSEO = ({
  ...
  const metaTags = /* @__PURE__ */ React__default.default.createElement(React__default.default.Fragment, null, /* @__PURE__ */ React__default.default.createElement("title", null, title), /* @__PURE__ */ React__default.default.createElement("meta", { name: "description", content: description }), /* @__PURE__ */ React__default.default.createElement("meta", { name: "robots", content: robotsContent }), canonical && /* @__PURE__ */ React__default.default.createElement("link", { rel: "canonical", href: canonical }), openGraph && /* @__PURE__ */ React__default.default.createElement(React__default.default.Fragment, null, /* @__PURE__ */ React__default.default.createElement("meta", { property: "og:type", content: openGraph.type || "website" }), /* @__PURE__ */ React__default.default.createElement("meta", { property: "og:title", content: openGraph.title || title }), /* @__PURE__ */ React__default.default.createElement("meta", { property: "og:description", content: openGraph.description || description }), openGraph.url && /* @__PURE__ */ React__default.default.createElement("meta", { property: "og:url", content: openGraph.url }), openGraph.siteName && /* @__PURE__ */ React__default.default.createElement("meta", { property: "og:site_name", content: openGraph.siteName }), openGraph.locale && /* @__PURE__ */ React__default.default.createElement("meta", { property: "og:locale", content: openGraph.locale }), openGraph.image && /* @__PURE__ */ React__default.default.createElement(React__default.default.Fragment, null, /* @__PURE__ */ React__default.default.createElement("meta", { property: "og:image", content: openGraph.image.url }), openGraph.image.width && /* @__PURE__ */ React__default.default.createElement("meta", { property: "og:image:width", content: String(openGraph.image.width) }), openGraph.image.height && /* @__PURE__ */ React__default.default.createElement("meta", { property: "og:image:height", content: String(openGraph.image.height) }), openGraph.image.alt && /* @__PURE__ */ React__default.default.createElement("meta", { property: "og:image:alt", content: openGraph.image.alt }))), twitter && /* @__PURE__ */ React__default.default.createElement(React__default.default.Fragment, null, /* @__PURE__ */ React__default.default.createElement("meta", { name: "twitter:card", content: twitter.card || "summary" }), twitter.site && /* @__PURE__ */ React__default.default.createElement("meta", { name: "twitter:site", content: twitter.site }), twitter.creator && /* @__PURE__ */ React__default.default.createElement("meta", { name: "twitter:creator", content: twitter.creator }), twitter.title && /* @__PURE__ */ React__default.default.createElement("meta", { name: "twitter:title", content: twitter.title }), twitter.description && /* @__PURE__ */ React__default.default.createElement("meta", { name: "twitter:description", content: twitter.description }), twitter.image && /* @__PURE__ */ React__default.default.createElement("meta", { name: "twitter:image", content: twitter.image }), twitter.imageAlt && /* @__PURE__ */ React__default.default.createElement("meta", { name: "twitter:image:alt", content: twitter.imageAlt })), alternates?.map((alternate) => /* @__PURE__ */ React__default.default.createElement(
    "link",
    {
  ...
  )), additionalMetaTags.map((tag, index) => /* @__PURE__ */ React__default.default.createElement("meta", { key: index, ...tag })), structuredData?.map((data, index) => /* @__PURE__ */ React__default.default.createElement(
    "script",
    {
      key: index,
  ...
  if (HeadComponent) {
    return /* @__PURE__ */ React__default.default.createElement(HeadComponent, null, metaTags);
  }
  return metaTags;
};
...
var Breadcrumbs = ({
  ...
  return /* @__PURE__ */ React__default.default.createElement(React__default.default.Fragment, null, /* @__PURE__ */ React__default.default.createElement(
  ...
  ), /* @__PURE__ */ React__default.default.createElement("nav", { "aria-label": "Breadcrumb", className: `breadcrumbs ${className}` }, /* @__PURE__ */ React__default.default.createElement("ol", { className: "flex items-center space-x-2" }, items.map((item, index) => /* @__PURE__ */ React__default.default.createElement("li", { key: index, className: "flex items-center" }, index > 0 && /* @__PURE__ */ React__default.default.createElement("span", { className: "mx-2 text-gray-500", "aria-hidden": "true" }, separator), item.url && index < items.length - 1 ? /* @__PURE__ */ React__default.default.createElement(
    import_link.default,
    {
      href: item.url,
    ...
    item.name
  ) : /* @__PURE__ */ React__default.default.createElement("span", { className: "text-gray-900", "aria-current": index === items.length - 1 ? "page" : void 0 }, item.name))))));
};
var FAQ = ({ items, className = "" }) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(React__default.default.Fragment, null, /* @__PURE__ */ React__default.default.createElement(
  ...
  ), /* @__PURE__ */ React__default.default.createElement("div", { className: `faq ${className}` }, /* @__PURE__ */ React__default.default.createElement("div", { className: "space-y-4" }, items.map((item, index) => /* @__PURE__ */ React__default.default.createElement(
    "div",
    {
      key: index,
    ...
    /* @__PURE__ */ React__default.default.createElement(
      ...
      /* @__PURE__ */ React__default.default.createElement("h3", { className: "text-lg font-medium text-gray-900" }, item.question),
      /* @__PURE__ */ React__default.default.createElement(
        "svg",
        {
        ...
        /* @__PURE__ */ React__default.default.createElement("path", { d: "M19 9l-7 7-7-7" })
      )
    ),
    /* @__PURE__ */ React__default.default.createElement(
      "div",
      ...
      /* @__PURE__ */ React__default.default.createElement("p", { className: "text-gray-700" }, item.answer)
    )
  )))));
};
var SmartLink = ({
