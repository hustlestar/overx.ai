    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement("nav", { "aria-label": "Breadcrumb", className: `breadcrumbs ${className}` },
            react_1.default.createElement("ol", { className: "flex items-center space-x-2" }, items.map((item, index) => (react_1.default.createElement("li", { key: index, className: "flex items-center" },
                ...
                item.url && index < items.length - 1 ? (react_1.default.createElement(link_1.default, { href: item.url, className: "text-blue-400 hover:text-blue-300 transition-colors" }, item.name)) : (react_1.default.createElement("span", { className: "text-white", "aria-current": index === items.length - 1 ? 'page' : undefined }, item.name)))))))));
};
