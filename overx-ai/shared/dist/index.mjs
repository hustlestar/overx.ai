...
var LazyLoad = ({
  ...
  return /* @__PURE__ */ React.createElement("div", { ref: containerRef, className }, isVisible ? children : placeholder);
};
var PreloadLink = ({ resources, HeadComponent }) => {
  const links = /* @__PURE__ */ React.createElement(React.Fragment, null, resources.map((resource, index) => /* @__PURE__ */ React.createElement(
    "link",
    {
      key: index,
      rel: "preload",
  ...
  return HeadComponent ? /* @__PURE__ */ React.createElement(HeadComponent, null, links) : links;
};
var PrefetchLink = ({ urls, HeadComponent }) => {
  const links = /* @__PURE__ */ React.createElement(React.Fragment, null, urls.map((url, index) => /* @__PURE__ */ React.createElement("link", { key: index, rel: "prefetch", href: url })));
  return HeadComponent ? /* @__PURE__ */ React.createElement(HeadComponent, null, links) : links;
};
var PreconnectLink = ({ origins, HeadComponent }) => {
  const links = /* @__PURE__ */ React.createElement(React.Fragment, null, origins.map((origin, index) => /* @__PURE__ */ React.createElement("link", { key: index, rel: "preconnect", href: origin })));
  return HeadComponent ? /* @__PURE__ */ React.createElement(HeadComponent, null, links) : links;
};
...
// lib/seo/contentOptimizer.ts
var ContentOptimizer = class {
  analyzeTitle(title, targetKeyword) {
    ...
    const hasPowerWord = powerWords.some(
  ...
  analyzeMetaDescription(description, targetKeyword) {
    ...
    const hasCTA = ctaWords.some(
      (word) => description.toLowerCase().includes(word.toLowerCase())
    );
    if (!hasCTA) {
  ...
  analyzeContent(content, targetKeyword, secondaryKeywords = []) {
    ...
    const missingSecondary = secondaryKeywords.filter(
  ...
  analyzeHeadings(headings, targetKeyword) {
    ...
    if (targetKeyword) {
      const headingsWithKeyword = headings.filter(
...
// content/keywords/keywordMap.ts
var keywordMap = {
  main: {
...
export { BaseSEO, Breadcrumbs, ContentOptimizer, FAQ, LazyLoad, OptimizedImage, PreconnectLink, PrefetchLink, PreloadLink, SmartLink, createArticleSchema, createBlogPostingSchema, createOrganizationSchema, createProductSchema, createSoftwareApplicationSchema, createWebSiteSchema, getKeywordsForPage, keywordMap };
